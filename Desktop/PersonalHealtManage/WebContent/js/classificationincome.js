...
Ext.onReady(function () {
	...
	var ageGroupClassificationStore1 = Ext.create('Ext.data.Store', {
		...
		proxy : {
			type : 'ajax',
			url :contextPath+'/dia/incomeclassifyUnRegister1.do',
			actionMethods:{
				read:'POST'
			},
			reader : {
	...
	var ageGroupClassificationStore2 = Ext.create('Ext.data.Store', {
		...
		proxy : {
			type : 'ajax',
			url :contextPath+'/dia/incomeclassifyUnRegister2.do',
			actionMethods:{
				read:'POST'
			},
			reader : {
	...
	var ageGroupClassificationStore3 = Ext.create('Ext.data.Store', {
		...
		proxy : {
			type : 'ajax',
			url :contextPath+'/dia/incomeclassifyUnRegister3.do',
			actionMethods:{
				read:'POST'
			},
			reader : {
	...
	var ageGroupClassificationStore4 = Ext.create('Ext.data.Store', {
		...
		proxy : {
			type : 'ajax',
			url :contextPath+'/dia/incomeclassifyUnRegister4.do',
			actionMethods:{
				read:'POST'
			},
			reader : {
