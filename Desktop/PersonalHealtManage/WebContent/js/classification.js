...
Ext.onReady(function () {
	...
	var ageGroupClassificationStore1 = Ext.create('Ext.data.Store', {
		...
		proxy : {
			type : 'ajax',
			url :contextPath+'/dia/ageclassifyUnRegister1.do',
			actionMethods:{
				read:'POST'
			},
			reader : {
	...
	var ageGroupClassificationStore2 = Ext.create('Ext.data.Store', {
		...
		proxy : {
			type : 'ajax',
			url :contextPath+'/dia/ageclassifyUnRegister2.do',
			actionMethods:{
				read:'POST'
			},
			reader : {
	...
	var ageGroupClassificationStore3 = Ext.create('Ext.data.Store', {
		...
		proxy : {
			type : 'ajax',
			url :contextPath+'/dia/ageclassifyUnRegister3.do',
			actionMethods:{
				read:'POST'
			},
			reader : {
	...
	var ageGroupClassificationStore4 = Ext.create('Ext.data.Store', {
		...
		proxy : {
			type : 'ajax',
			url :contextPath+'/dia/ageclassifyUnRegister4.do',
			actionMethods:{
				read:'POST'
			},
			reader : {
	    ...
	    series: [{
	        ...
	        tips: {
	          ...
	          renderer: function(storeItem, item) {
	            this.setTitle('Age Group = '+storeItem.get('ageGroup'));
	          }
	        },
	        label: {
	          display: 'insideEnd',
