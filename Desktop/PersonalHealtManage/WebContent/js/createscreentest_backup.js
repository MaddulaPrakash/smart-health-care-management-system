...
//						ratStore.removeAll();
						...
						if (modelObj) {
							 ...
							 * 
							 * var sugGridPCmp=Ext.getCmp('ratGrid');
							 * 
							 * sugGridPCmp.setVisible(true);
							 * 
							 * var
							 * r={'testName':testName,'r1LL':r1LL,'r1HL':r1HL,'r2LL':r2LL,'r2HL':r2HL,'r3LL':r3LL,'r3HL':r3HL};
							 * 
							 * ratStore.insert(0,r);
							 */
							var textMsg = "TEST NAME =  " + testName + "---->"
									+ "RATING1 LL =    " + r1LL + "RATING1 HL=   "
									+ r1HL + "RATING2 LL=   " + r2LL
									+ "RATING2 HL=   " + r2HL + "RATING3 LL=   "
									+ r3LL + "RATING4 HL=   " + r3HL;

							Ext.Msg.alert('status',textMsg);
