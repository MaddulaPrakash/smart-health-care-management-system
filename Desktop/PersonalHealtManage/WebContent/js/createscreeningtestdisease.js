		...
		items : [ {
			...
			handler : function(btn, args) {
				...
				if (status == true) {
					...
					if (questDetails) {
						urlLink = contextPath + '/dia/createScreenTestDisease.do';
						hideConfirmationMsg();
...
//						ratStore.removeAll();
						...
						if (modelObj) {
							...
							var textMsg = "The Test name is : {<h2>"+testName+"</h2>}"+"<br/>No Fever Range is :{"+r1LL +"to"+r1HL+"}"+"<br/>"
							+"Viral Fever is :{"+r2LL +"to"+r2HL+"}"+"<br/>"
							+"Thyhoid range is :{"+r3LL +"to"+r3HL+"}"+"<br/>"
							+"Dengue Range is :{"+r4LL +"to"+r4HL+"}"+"<br/>";
