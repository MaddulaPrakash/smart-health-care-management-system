...
Ext.onReady(function () {
	...
	var ageGroupClassificationStore1 = Ext.create('Ext.data.Store', {
		...
		proxy : {
			type : 'ajax',
			url :contextPath+'/dia/profexpclassifyUnRegister1Disease.do',
			actionMethods:{
				read:'POST'
			},
			reader : {
	...
	var ageGroupClassificationStore2 = Ext.create('Ext.data.Store', {
		...
		proxy : {
			type : 'ajax',
			url :contextPath+'/dia/profexpclassifyUnRegister2Disease.do',
			actionMethods:{
				read:'POST'
			},
			reader : {
	...
	var ageGroupClassificationStore3 = Ext.create('Ext.data.Store', {
		...
		proxy : {
			type : 'ajax',
			url :contextPath+'/dia/profexpclassifyUnRegister3Disease.do',
			actionMethods:{
				read:'POST'
			},
			reader : {
	...
	var ageGroupClassificationStore4 = Ext.create('Ext.data.Store', {
		...
		proxy : {
			type : 'ajax',
			url :contextPath+'/dia/profexpclassifyUnRegister4Disease.do',
			actionMethods:{
				read:'POST'
			},
			reader : {
