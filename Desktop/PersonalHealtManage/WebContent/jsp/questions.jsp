...
<p>Note: 1) This is a voluntary exercise for persons interested in knowing their stress levels. This will 
                take about 30 minutes.</p>
 <p>2) Select Take test to know your stress level</p>
<p>3) Save and Submit all your answers for analysis and display</p>
...
<div class="isa_success">
	...
	<font color="red"></font>
	<form action="<%=request.getContextPath()%>/dia/onlineTest.do" method="post">
