...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/errormsg.css" />

<script type="text/javascript" >
var contextPath='<%=request.getContextPath()%>';
</script>
<script type="text/javascript" src="<%=request.getContextPath()%>/extjs41/ext-all-debug.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/viewspecficscreeningtestdisease.js"></script>
<script type="text/javascript">
...
<div class="isa_info">Please Select the Test Names from Combo</div>
