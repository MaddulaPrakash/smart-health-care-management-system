				...
				<div class="sl-slider">
					...
					<div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
						...
						<div class="slide-caption">
                            <div class="caption-content">
                                <h2 class="animated fadeInDown">I Care</h2>
                                <span class="animated fadeInDown">Manage Healt,Become Stress Free</span>
                               	<a href="<%=request.getContextPath()%>/jsp/registerintialview.jsp" class="btn btn-blue btn-effect">Stress Level Test</a>
                                <a href="<%=request.getContextPath()%>/jsp/registerview.jsp" class="btn btn-blue btn-effect">Sign Up</a>
								 ...
								 <span>This is for  knowing your stress levels and is used for academic purpose. The data will be confidential</span>	
                            </div>
                        </div>
					...
					<div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
						...
						<div class="slide-caption">
                            <div class="caption-content">
                                <h2>I Care</h2>
                                <span>Manage Healt,Become Stress Free</span>
					...
					<div class="row">
						<div class="col-md-4 wow animated fadeInLeft">
							<div class="recent-works">
								...
								<div id="works">
									<div class="work-item">
										<p>Stress Excercises> <br> This is better way to improve the healt & Reduce Stress Value</p>
									</div>
									<div class="work-item">
										<p>Gym <br><br> Going to Gym improves Stress Management</p>
									</div>
									<div class="work-item">
								...
								<h3>Welcome To Forthis & Columbia Asia</h3>								
						     	 <div class="message-body">
									<img src="<%=request.getContextPath()%>/img/member-1.jpg" class="pull-left" alt="member">
						       		<p>V-Care Hospital believes in delivering efficient, safe and affordable medical care through quality management using state-of-the-art technology with good Health Care facilities.</p>
						     	 </div>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-12 text-center wow animated zoomIn" data-wow-delay="0.3s">
							<div class="service-item">
								...
								<h3>Lose Weight</h3>
								<p>ose It! is designed with one goal - to help you lose weight in a healthy, sustainable way. No magic pills, no crazy diets - just a simple, easy-to-use program that helps you stay in your calorie budget. But don't take our word for it.
						...
						<div class="col-md-3 col-sm-6 col-xs-12 text-center wow animated zoomIn" data-wow-delay="0.6s">
							<div class="service-item">
								...
								<h3>Stress Techniques</h3>
								<p>A few minutes of practice per day can help ease anxiety. 
								Research suggests that daily meditation may alter the brain’s neural pathways, making you more resilient to stress </p>
							</div>
						</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="sec-title text-center wow animated fadeInDown">
							<h2>Stress Management Centers</h2>
							<p>Our Locations</p>
						</div>
						...
						<ul class="project-wrapper wow animated fadeInUp">
							...
							<li class="portfolio-item">
								<img src="<%=request.getContextPath()%>/img/portfolio/item4.jpg" class="img-responsive" alt="Bangalore IT Stress Solutions">
								<figcaption class="mask">
									<h3>India</h3>
									<p>Bangalore IT Stress Solutions </p>
								</figcaption>
								<ul class="external">
							...
							<li class="portfolio-item">
								<img src="<%=request.getContextPath()%>/img/portfolio/item5.jpg" class="img-responsive" alt="Cricket Team Australia Regular Stress Management">
								<figcaption class="mask">
									<h3>Australia</h3>
									<p>Cricket Team Australia Regular Stress Management </p>
								</figcaption>
								<ul class="external">
							...
							<li class="portfolio-item">
								<img src="<%=request.getContextPath()%>/img/portfolio/item6.jpg" class="img-responsive" alt="Africa Home Stress Management">
								<figcaption class="mask">
									<h3>South Africa</h3>
									<p>Africa Home Stress Management </p>
								</figcaption>
								<ul class="external">
						...
						<div class="row">
							...
							<div id="testimonial" class=" wow animated fadeInUp">
								...
								<div class="testimonial-item text-center">
									...
									<div class="clearfix">
										<span> Jessica</span>
										<p>Jessica Ann Barazon is a renowned health writer and health enthusiast specializing in relationships, life improvement, ADHD, parenting, mental health, fitness and weight loss. She completed her B.A. in Pychology from Minanao State. She is especially interested in feminist ethics, psychology, and mental health awareness. Aside from writing she also loves food, dogs, fashion and travel.</p>
									</div>
								</div>
								<div class="testimonial-item text-center">
									<img src="<%=request.getContextPath()%>/img/member-1.jpg" alt="Our Clients">
									<div class="clearfix">
										<span>Sachin</span>
										<p>The worlds best Stress Management Solution</p>
									</div>
								</div>
							</div>
			...
			<section id="price">
				<div class="container">
					<div class="row">
						...
						<div class="sec-title text-center wow animated fadeInDown">
							<h2>Price</h2>
							<p>Our price for your  Stress Control</p>
						</div>
			...
			<div class="container">
				<div class="row text-center">
					<div class="footer-content">
						...
						<p>Stress Management is responsible for excercising</p>
					</div>
				</div>
			</div>
		</footer>
