                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            <ul class="nav navbar-nav navbar-nav-right">
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="<%=request.getContextPath()%>/jsp/patient.jsp">Customer Home</a></li>
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="<%=request.getContextPath()%>/jsp/dashboard.jsp">Dashboard</a></li>
            ...
            <div class="carousel-inner" role="listbox">
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                <h1 class="carousel-title">User</h1>
                                ...
                                <%
                                                                	AJAXResponse ajaxResponse = (AJAXResponse) request
                                                                                    			...
                                                                                    			if(ajaxResponse!=null){
                                                                                    				...
                                                                                    				List<Message> ebErrors = ajaxResponse.getEbErrors();
                                                                                    				...
                                                                                    				if(ebErrors!=null && !ebErrors.isEmpty()){
                                                                                    					...
                                                                                    					if(msg!=null){
                                                                                    						...
                                                                                    						String errMsg = msg.getErrMessage();
                                                                %>
                    			<p class="color-white">Error Message is:<br/><%=errMsg%></p>
                    			<%
                    				}
                    				}
                    			}
                ...
                <div class="item">
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                <h2 class="carousel-title">User</h2>
